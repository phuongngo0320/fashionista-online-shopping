...
$sql = "SELECT * FROM products WHERE forGender ='male' and (categoryKind ='giay' or categoryKind ='dep')LIMIT $start,$limit";
$result = mysqli_query($conn, $sql);

$products = mysqli_fetch_all($result, MYSQLI_ASSOC);

// Paging
$sql1 = "SELECT count(pro_id) AS pro_id FROM products  WHERE forGender ='male' and (categoryKind ='giay' or categoryKind ='dep')";
    ...
    <div class="d-flex" style="margin-top: 75px">
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-sidebar" style="width: 260px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="giay-dep_male.php" class="nav-link active" aria-current="page">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gender-male" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M9.5 2a.5.5 0 0 1 0-1h5a.5.5 0 0 1 .5.5v5a.5.5 0 0 1-1 0V2.707L9.871 6.836a5 5 0 1 1-.707-.707L13.293 2H9.5zM6 6a4 4 0 1 0 0 8 4 4 0 0 0 0-8z" />
                        </svg>
                        Giày & dép cho Nam
        ...
        <div class="container">
            ...
            <ul class="pagination button-group d-flex justify-content-end mb-5 me-5">
                <li class="page-item"><a class="page-link" href="giay-dep_male.php?page=<?php echo $previous; ?>">Previous</a></li>
                <?php for ($i = 1; $i <= $pages; $i++) : ?>
                    <li class="page-item"><a class="page-link" href="giay-dep_male.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                <?php endfor; ?>

                <li class="page-item"><a class="page-link" href="giay-dep_male.php?page=<?php echo $next; ?>">Next</a></li>
            </ul>
        </div>
    </div>
