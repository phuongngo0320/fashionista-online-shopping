...
$sql = "SELECT * FROM products  WHERE forGender ='female' and (categoryKind ='quan' or categoryKind ='ao') LIMIT $start,$limit";
$result = mysqli_query($conn, $sql);

$products = mysqli_fetch_all($result, MYSQLI_ASSOC);

// Paging
$sql1 = "SELECT count(pro_id) AS pro_id  FROM products WHERE forGender ='female' and (categoryKind ='quan' or categoryKind ='ao')";
    ...
    <div class="d-flex" style="margin-top: 75px">
        ...
        <div class="container">
            ...
            <ul class="pagination button-group d-flex justify-content-end mb-5 me-5">
                <li class="page-item"><a class="page-link" href="quan-ao_female.php?page=<?php echo $previous; ?>">Previous</a></li>
                <?php for ($i = 1; $i <= $pages; $i++) : ?>
                    <li class="page-item"><a class="page-link" href="quan-ao_female.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                <?php endfor; ?>

                <li class="page-item"><a class="page-link" href="quan-ao_female.php?page=<?php echo $next; ?>">Next</a></li>
            </ul>
        </div>
    </div>
